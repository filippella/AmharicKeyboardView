...
public class SymbolsOneInputKeysInfo extends BaseInputKeysInfo {
    ...
    private void populateKeys() {
        ...
        keysRow2.addKeyInfo(new KeyInfo("{", 1, true, KeyInfo.KEY_EVENT_NORMAL));
        keysRow2.addKeyInfo(new KeyInfo("}", 1, true, KeyInfo.KEY_EVENT_NORMAL));
        keysRow2.addKeyInfo(new KeyInfo("_", 1, true, KeyInfo.KEY_EVENT_NORMAL));
        keysRow2.addKeyInfo(new KeyInfo("<", 1, true, KeyInfo.KEY_EVENT_NORMAL));
        keysRow2.addKeyInfo(new KeyInfo(">", 1, true, KeyInfo.KEY_EVENT_NORMAL));
        ...
        keysRow4.addKeyInfo(new KeyInfo(R.mipmap.ic_keyboard_caps, 1, false, KeyInfo.KEY_EVENT_SYMBOLS_TWO).setPadding(8));
